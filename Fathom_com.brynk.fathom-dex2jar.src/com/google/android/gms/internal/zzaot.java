...
public final class zzaot
{
  ...
  public zzaot zza(zzaoo[] paramArrayOfzzaoo)
  {
    int j = paramArrayOfzzaoo.length;
    int i = 0;
    while (i < j)
    {
      zzaoo localzzaoo = paramArrayOfzzaoo[i];
  ...
  public zzaot zzf(int[] paramArrayOfInt)
  {
    this.bom = this.bom.zzg(paramArrayOfInt);
    return this;
  }
}
