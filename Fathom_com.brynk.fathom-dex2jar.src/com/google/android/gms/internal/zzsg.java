...
public class zzsg
{
  ...
  private final zzb BG = new zzb()
  {
    ...
    {
      zzsg.this.BF.remove(paramzzqq);
      if ((paramzzqq.zzarh() != null) && (zzsg.zza(zzsg.this) != null))
        zzsg.zza(zzsg.this).remove(paramzzqq.zzarh().intValue());
    }
  };
  ...
  private static void zza(zzqq<?> paramzzqq, zze paramzze, IBinder paramIBinder)
  {
    ...
    if ((paramIBinder != null) && (paramIBinder.isBinderAlive()))
    {
      ...
      catch (android.os.RemoteException paramIBinder)
      {
        paramzzqq.cancel();
