...
public final class zzaos
{
  ...
  private zzapk<Number> zza(zzapi paramzzapi)
  {
    ...
    return new zzapk()
    {
        ...
        throws IOException
      {
        ...
        paramzzaqr.zzut(paramNumber.toString());
      }
        ...
        throws IOException
      {
        ...
        return Long.valueOf(paramzzaqp.nextLong());
      }
    };
  }
  ...
  private zzapk<Number> zzdf(boolean paramBoolean)
  {
    ...
    return new zzapk()
    {
      ...
      public Double zze(zzaqp paramzzaqp)
        throws IOException
      {
        if (paramzzaqp.bq() == zzaqq.brJ)
        {
  ...
  private zzapk<Number> zzdg(boolean paramBoolean)
  {
    ...
    return new zzapk()
    {
      ...
      public Float zzf(zzaqp paramzzaqp)
        throws IOException
      {
        if (paramzzaqp.bq() == zzaqq.brJ)
        {
 ...
 * Qualified Name:     com.google.android.gms.internal.zzaos
