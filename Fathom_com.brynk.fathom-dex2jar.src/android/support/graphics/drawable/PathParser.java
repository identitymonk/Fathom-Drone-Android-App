...
class PathParser
{
  ...
  public static class PathDataNode
  {
    ...
    private PathDataNode(PathDataNode paramPathDataNode)
    {
      ...
      this.params = PathParser.access$300(paramPathDataNode.params, 0, paramPathDataNode.params.length);
    }
    ...
    private static void addCommand(Path paramPath, float[] paramArrayOfFloat1, char paramChar1, char paramChar2, float[] paramArrayOfFloat2)
    {
      ...
      case 'a':
        ...
        {
          bool1 = true;
          label1771: if (paramArrayOfFloat2[(paramChar1 + '\004')] == 0.0F)
            break label1857;
        }
        label1857: for (boolean bool2 = true; ; bool2 = false)
        {
        ...
        {
          bool1 = true;
          label1918: if (paramArrayOfFloat2[(paramChar1 + '\004')] == 0.0F)
            break label1992;
        }
        label1992: for (bool2 = true; ; bool2 = false)
        {
