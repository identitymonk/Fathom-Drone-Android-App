  ...
  implements MenuBuilder.Callback, LayoutInflaterFactory
{
  ...
  private ViewGroup createSubDecor()
  {
    ...
    while (true)
    {
      ...
      break;
      label273: if (!this.mHasActionBar)
        continue;
      ...
      label436: if (this.mOverlayActionMode);
      ...
      label493: ((FitWindowsViewGroup)localObject1).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener()
      {
        public void onFitSystemWindows(Rect paramRect)
        {
          paramRect.top = AppCompatDelegateImplV7.this.updateStatusGuard(paramRect.top);
        }
      });
    }
    label513: if (this.mDecorContentParent == null)
    ...
    return (ViewGroup)(ViewGroup)localObject1;
  }
  ...
  private int updateStatusGuard(int paramInt)
  {
    ...
    label406: for (paramInt = i1; ; paramInt = 8)
    {
      ...
      label322: j = 0;
      break;
      label327: localObject2 = this.mStatusGuard.getLayoutParams();
      i = j;
      ...
      while (true)
      {
        ...
        if (this.mActionModeView == null)
        {
          ...
          if (((TypedValue)localObject3).resourceId != 0)
          {
            ...
            label216: this.mActionModeView = new ActionBarContextView((Context)localObject1);
        ...
        {
          label334: if (this.mActionModeView == null)
            break label546;
          endOnGoingFadeAnimation();
        ...
        label546: label548: for (boolean bool = true; ; bool = false)
        {
          ...
          break label216;
          label501: localObject1 = (ViewStubCompat)this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
          if (localObject1 == null)
            break label334;
        ...
        label553: this.mActionMode = null;
      }
    }
    catch (AbstractMethodError localObject2)
    {
      while (true)
