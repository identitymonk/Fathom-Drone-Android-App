...
class AlertController
{
  ...
  private final View.OnClickListener mButtonHandler = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      if ((paramView == AlertController.this.mButtonPositive) && (AlertController.this.mButtonPositiveMessage != null))
        paramView = Message.obtain(AlertController.this.mButtonPositiveMessage);
      while (true)
      {
        if (paramView != null)
        ...
        {
          paramView = Message.obtain(AlertController.this.mButtonNegativeMessage);
          continue;
        }
        if ((paramView == AlertController.this.mButtonNeutral) && (AlertController.this.mButtonNeutralMessage != null))
        {
          paramView = Message.obtain(AlertController.this.mButtonNeutralMessage);
          continue;
        }
        paramView = null;
      }
  ...
  private void setScrollIndicators(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener(paramView, (View)localObject)
        {
          ...
          {
            AlertController.access$800(paramNestedScrollView, this.val$top, this.val$bottom);
          }
        });
        this.mScrollView.post(new Runnable(paramView, (View)localObject)
        {
          public void run()
          {
            AlertController.access$800(AlertController.this.mScrollView, this.val$top, this.val$bottom);
          }
        });
        return;
      }
      ...
      {
        this.mListView.setOnScrollListener(new AbsListView.OnScrollListener(paramView, (View)localObject)
        {
          public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
          {
            AlertController.access$800(paramAbsListView, this.val$top, this.val$bottom);
          }
        ...
        this.mListView.post(new Runnable(paramView, (View)localObject)
        {
          public void run()
          {
            AlertController.access$800(AlertController.this.mListView, this.val$top, this.val$bottom);
          }
        });
        return;
      }
  ...
  private void setupButtons(ViewGroup paramViewGroup)
  {
    ...
    if (TextUtils.isEmpty(this.mButtonPositiveText))
    {
      ...
      label92: this.mButtonNeutral = ((Button)paramViewGroup.findViewById(16908315));
    ...
    while (true)
    {
      ...
      i = 0x0 | 0x1;
      break;
      label179: this.mButtonNegative.setText(this.mButtonNegativeText);
      this.mButtonNegative.setVisibility(0);
      i |= 2;
      break label92;
      label205: this.mButtonNeutral.setText(this.mButtonNeutralText);
  ...
  private void setupView()
  {
    ...
    if ((localObject2 != null) && (((ViewGroup)localObject2).getVisibility() != 8))
    {
      ...
      if ((localObject4 == null) || (((ViewGroup)localObject4).getVisibility() == 8))
        break label341;
      k = 1;
      label173: if ((localObject1 == null) || (((ViewGroup)localObject1).getVisibility() == 8))
        break label346;
      j = 1;
      label190: if ((j == 0) && (localObject3 != null))
      {
    ...
    label341: label346: label351: label360: label365: for (int j = 2; ; j = 0)
    {
  ...
  public static class AlertParams
  {
    ...
    private void createListView(AlertController paramAlertController)
    {
      ...
      if (this.mIsMultiChoice)
        ...
        {
          localObject = new ArrayAdapter(this.mContext, paramAlertController.mMultiChoiceItemLayout, 16908308, this.mItems, localListView)
          {
          ...
          if (this.mOnClickListener == null)
            break label274;
          localListView.setOnItemClickListener(new AdapterView.OnItemClickListener(paramAlertController)
          {
          ...
          label110: if (this.mOnItemSelectedListener != null)
      ...
      while (true)
      {
        ...
        return;
        localObject = new CursorAdapter(this.mContext, this.mCursor, false, localListView, paramAlertController)
        {
        ...
        label237: if (this.mAdapter != null)
        {
        ...
        break;
        label274: if (this.mOnCheckboxClickListener == null)
          break label110;
        localListView.setOnItemClickListener(new AdapterView.OnItemClickListener(localListView, paramAlertController)
        {
          public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
          {
        ...
        break label110;
        label300: if (!this.mIsMultiChoice)
          continue;
