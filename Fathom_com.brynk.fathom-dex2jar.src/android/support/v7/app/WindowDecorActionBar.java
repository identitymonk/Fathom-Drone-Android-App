  ...
  implements ActionBarOverlayLayout.ActionBarVisibilityCallback
{
  ...
  public void animateToMode(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      hideForActionMode();
      break;
      label68: localViewPropertyAnimatorCompat1 = this.mDecorToolbar.setupAnimatorToVisibility(0, 200L);
  ...
  public void doHide(boolean paramBoolean)
  {
    ...
    if ((this.mCurWindowVisibility == 0) && (ALLOW_SHOW_HIDE_ANIMATIONS) && ((this.mShowHideAnimationEnabled) || (paramBoolean)))
    {
      ...
      if (paramBoolean)
      {
        ...
        tmp90_86[1] = 0;
        tmp90_86;
        this.mContainerView.getLocationInWindow(localObject);
        f1 = f2 - localObject[1];
      }
  ...
  public void setNavigationMode(int paramInt)
  {
    ...
    default:
      ...
      default:
        ...
        {
          bool1 = true;
          label108: ((DecorToolbar)localObject).setCollapsible(bool1);
          localObject = this.mOverlayLayout;
          if ((paramInt != 2) || (this.mHasEmbeddedTabs))
            break label210;
        }
    ...
    label210: for (boolean bool1 = bool2; ; bool1 = false)
    {
    ...
    implements MenuBuilder.Callback
  {
    ...
    public void finish()
    {
      if (WindowDecorActionBar.this.mActionMode != this)
        return;
      if (!WindowDecorActionBar.access$700(WindowDecorActionBar.this.mHiddenByApp, WindowDecorActionBar.this.mHiddenBySystem, false))
      {
