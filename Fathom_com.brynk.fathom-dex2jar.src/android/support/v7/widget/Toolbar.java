...
public class Toolbar extends ViewGroup
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (ViewCompat.getLayoutDirection(this) == 1)
    {
      ...
      else
      {
        ...
        if (((!paramBoolean) || (this.mTitleTextView.getMeasuredWidth() <= 0)) && ((!bool) || (this.mSubtitleTextView.getMeasuredWidth() <= 0)))
          break label1024;
        i = 1;
        label530: switch (this.mGravity & 0x70)
        {
        default:
    ...
    for (paramInt2 = this.mTitleMarginStart; ; paramInt2 = 0)
    {
      ...
      j = 0;
      break;
      label901: paramInt1 = layoutChildLeft(this.mNavButtonView, paramInt3, arrayOfInt, i1);
      paramInt2 = paramInt4;
      break label120;
      label922: paramInt3 = layoutChildLeft(this.mCollapseButtonView, paramInt1, arrayOfInt, i1);
      paramInt4 = paramInt2;
      break label160;
      label943: paramInt1 = layoutChildRight(this.mMenuView, paramInt4, arrayOfInt, i1);
      paramInt2 = paramInt3;
      break label200;
      label964: paramInt1 = layoutChildLeft(this.mExpandedActionView, paramInt3, arrayOfInt, i1);
      paramInt2 = paramInt4;
      break label300;
      label985: paramInt3 = layoutChildLeft(this.mLogoView, paramInt1, arrayOfInt, i1);
      paramInt4 = paramInt2;
      break label340;
      label1006: localObject1 = this.mSubtitleTextView;
      break label467;
      label1015: localObject2 = this.mTitleTextView;
      break label478;
      label1024: i = 0;
      break label530;
