  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new RecyclerView.OnItemTouchListener()
  {
    public boolean onInterceptTouchEvent(RecyclerView paramRecyclerView, MotionEvent paramMotionEvent)
    {
      ...
      if (i == 0)
      {
        ItemTouchHelper.this.mActivePointerId = MotionEventCompat.getPointerId(paramMotionEvent, 0);
      ...
      while (true)
      {
        ...
        if (ItemTouchHelper.this.mActivePointerId == -1)
          continue;
        int j = MotionEventCompat.findPointerIndex(paramMotionEvent, ItemTouchHelper.this.mActivePointerId);
        if (j < 0)
          continue;
    ...
    public void onTouchEvent(RecyclerView paramRecyclerView, MotionEvent paramMotionEvent)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          k = MotionEventCompat.findPointerIndex(paramMotionEvent, ItemTouchHelper.this.mActivePointerId);
          if (k >= 0)
      ...
      while (MotionEventCompat.getPointerId(paramMotionEvent, j) != ItemTouchHelper.this.mActivePointerId);
      if (j == 0)
        i = 1;
      ItemTouchHelper.this.mActivePointerId = MotionEventCompat.getPointerId(paramMotionEvent, i);
  ...
  private void postDispatchSwipe(RecoverAnimation paramRecoverAnimation, int paramInt)
  {
  ...
  private boolean scrollIfNecessary()
  {
    ...
    label440: this.mDragScrollStartTimeInMs = -9223372036854775808L;
    return false;
  }
