...
public class ActionBarContextView extends AbsActionBarView
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      ...
      label216: if (this.mMenuView != null)
      {
    ...
    label258: label267: label277: label290: for (paramBoolean = true; ; paramBoolean = false)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int k;
    int j;
    label391: if (this.mContentHeight > 0)
    {
      ...
      label328: if (this.mCustomView != null)
      {
    ...
    while (true)
    {
      ...
      break label322;
      label506: paramInt2 = measureChildView(this.mTitleLayout, paramInt1, j, 0);
      break label328;
