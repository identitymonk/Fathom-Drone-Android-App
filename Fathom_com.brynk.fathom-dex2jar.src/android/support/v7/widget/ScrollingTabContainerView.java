  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  public void animateToTab(int paramInt)
  {
    ...
    this.mTabSelector = new Runnable(localView)
    {
      public void run()
      {
        ...
        int j = (ScrollingTabContainerView.this.getWidth() - this.val$tabView.getWidth()) / 2;
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 1073741824)
    {
      ...
      label67: this.mMaxTabWidth = Math.min(this.mMaxTabWidth, this.mStackedTabMaxWidth);
      label82: i = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, 1073741824);
    ...
    while (true)
    {
      ...
      bool = false;
      break;
      label179: this.mMaxTabWidth = (View.MeasureSpec.getSize(paramInt1) / 2);
      break label67;
      label192: this.mMaxTabWidth = -1;
      break label82;
      label200: paramInt2 = 0;
      break label107;
      label205: performExpand();
      continue;
      label213: performExpand();
    }
  }
