...
public class ListPopupWindow
{
  ...
  private int buildDropDown()
  {
    ...
    View localView;
    Object localObject1;
    label261: label277: label325: int k;
      ...
      if (!this.mModal)
      {
        ...
        this.mDropDownList.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
          public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
          {
            if (paramInt != -1)
            {
              paramAdapterView = ListPopupWindow.this.mDropDownList;
    ...
    label563: switch (this.mDropDownWidth)
    {
    default:
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    if ((isShowing()) && (paramInt != 62) && ((this.mDropDownList.getSelectedItemPosition() >= 0) || (!isConfirmKey(paramInt))))
    {
      ...
      label162: label175: for (j = localListAdapter.getCount() - 1; ; j = this.mDropDownList.lookForSelectablePosition(localListAdapter.getCount() - 1, false))
      {
      ...
      label197: DropDownListView.access$502(this.mDropDownList, false);
  ...
  public void show()
  {
    ...
    if (this.mPopup.isShowing())
    {
      ...
      while (true)
      {
        ...
        label219: k = 0;
        break label85;
        label224: localPopupWindow = this.mPopup;
        if (this.mDropDownWidth == -1);
        for (k = -1; ; k = 0)
        {
          localPopupWindow.setWidth(k);
    ...
    {
      i = -1;
      label298: if (this.mDropDownHeight != -1)
        break label467;
      j = -1;
      label308: this.mPopup.setWidth(i);
    ...
    while (true)
    {
      ...
      i = this.mDropDownWidth;
      break label298;
      label467: if (this.mDropDownHeight == -2)
        break label308;
      j = this.mDropDownHeight;
      break label308;
