  ...
  implements DecorContentParent, NestedScrollingParent
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((this.mWindowContentOverlay != null) && (!this.mIgnoreWindowContentOverlay))
      if (this.mActionBarTop.getVisibility() != 0)
        break label82;
    label82: for (int i = (int)(this.mActionBarTop.getBottom() + ViewCompat.getTranslationY(this.mActionBarTop) + 0.5F); ; i = 0)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((ViewCompat.getWindowSystemUiVisibility(this) & 0x100) != 0)
    {
      ...
      label149: this.mContentInsets.set(this.mBaseContentInsets);
    ...
    while (true)
    {
      ...
      j = 0;
      break;
      label436: if (this.mActionBarTop.getVisibility() == 8)
        break label149;
      i = this.mActionBarTop.getMeasuredHeight();
      break label149;
      label459: localObject = this.mInnerInsets;
      ((Rect)localObject).top += i;
  ...
  public void onWindowSystemUiVisibilityChanged(int paramInt)
  {
    ...
    if ((paramInt & 0x4) == 0)
    {
      ...
      if ((paramInt & 0x100) == 0)
        break label120;
      j = 1;
      label49: if (this.mActionBarVisibilityCallback != null)
      {
    ...
    while (true)
    {
      ...
      label125: bool = false;
      break label66;
      label131: this.mActionBarVisibilityCallback.hideForSystem();
    }
  }
