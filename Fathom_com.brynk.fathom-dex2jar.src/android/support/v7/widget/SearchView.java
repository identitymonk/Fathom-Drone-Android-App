  ...
  implements CollapsibleActionView
{
  ...
  View.OnKeyListener mTextKeyListener = new View.OnKeyListener()
  {
    public boolean onKey(View paramView, int paramInt, KeyEvent paramKeyEvent)
    {
      ...
      while ((SearchView.SearchAutoComplete.access$1600(SearchView.this.mSearchSrcTextView)) || (!KeyEventCompat.hasNoModifiers(paramKeyEvent)) || (paramKeyEvent.getAction() != 1) || (paramInt != 66));
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    while (true)
    {
      ...
      updateQueryHint();
      return;
      label767: addOnLayoutChangeListenerToDropDownAnchorBase();
    }
  }
  ...
  private void adjustDropDownSizeAndPosition()
  {
    ...
    label142: label147: for (int j = -localRect.left; ; j = k - (localRect.left + i))
    {
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    ...
    catch (RuntimeException paramString)
    {
      while (true)
      {
        ...
        label228: Object localObject2 = localObject1;
        if (localObject1 != null)
          continue;
        localObject2 = "android.intent.action.SEARCH";
        continue;
        label245: if (localObject3 != null)
          continue;
  ...
  private boolean hasVoiceSearch()
  {
    ...
    while (true)
    {
      ...
      return i;
      label69: if (!this.mSearchable.getVoiceSearchLaunchRecognizer())
        continue;
  ...
  private void onTextChanged(CharSequence paramCharSequence)
  {
    ...
    label101: for (boolean bool1 = bool2; ; bool1 = false)
    {
  ...
  private void updateViewsVisibility(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (TextUtils.isEmpty(this.mSearchSrcTextView.getText()))
        break label121;
      bool1 = true;
      label33: this.mSearchButton.setVisibility(i);
      updateSubmitButton(bool1);
      View localView = this.mSearchEditFrame;
      if (!paramBoolean)
        break label127;
      i = j;
      label59: localView.setVisibility(i);
    ...
    label132: label137: for (paramBoolean = bool2; ; paramBoolean = false)
    {
    ...
    AutoCompleteTextViewReflector()
    {
      try
      {
        ...
        try
        {
          ...
          try
          {
            label50: this.ensureImeVisible = AutoCompleteTextView.class.getMethod("ensureImeVisible", new Class[] { Boolean.TYPE });
            this.ensureImeVisible.setAccessible(true);
            try
            {
              label79: this.showSoftInputUnchecked = InputMethodManager.class.getMethod("showSoftInputUnchecked", new Class[] { Integer.TYPE, ResultReceiver.class });
