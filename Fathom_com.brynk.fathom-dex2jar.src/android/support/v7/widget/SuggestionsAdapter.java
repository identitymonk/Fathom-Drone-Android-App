  ...
  implements View.OnClickListener
{
  ...
  public void bindView(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    while (true)
    {
      ...
      return;
      label218: paramView = getStringOrNull(paramCursor, this.mText2Col);
      break;
      label230: if (paramContext.mText1 == null)
        continue;
      paramContext.mText1.setSingleLine(true);
      paramContext.mText1.setMaxLines(1);
    }
    label256: paramContext.mIconRefine.setVisibility(8);
  }
  ...
  public Cursor runQueryOnBackgroundThread(CharSequence paramCharSequence)
  {
    ...
    while (true)
    {
      ...
      try
      {
        label40: paramCharSequence = getSearchManagerSuggestions(this.mSearchable, paramCharSequence, 50);
        if (paramCharSequence == null)
          continue;
