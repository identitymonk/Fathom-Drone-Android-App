  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  private void showPopupUnchecked(int paramInt)
  {
    ...
    boolean bool;
    int i;
    label60: label92: ListPopupWindow localListPopupWindow;
    ...
    while (true)
    {
      ...
      label192: i = 0;
      break label60;
      label197: this.mAdapter.setShowFooterView(false);
      this.mAdapter.setMaxActivityCount(paramInt);
      break label92;
      label216: this.mAdapter.setShowDefaultActivity(false, false);
    }
  }
  ...
  private void updateAppearance()
  {
    ...
    while (true)
    {
      ...
      break;
      label161: this.mDefaultActivityButton.setVisibility(8);
    }
    label173: this.mActivityChooserContent.setBackgroundDrawable(null);
  }
