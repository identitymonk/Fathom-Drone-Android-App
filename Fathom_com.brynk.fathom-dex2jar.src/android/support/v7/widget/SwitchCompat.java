...
public class SwitchCompat extends CompoundButton
{
  ...
  private void animateThumbToCheckedState(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      this.mPositionAnimator.setAnimationListener(new Animation.AnimationListener(paramBoolean)
      {
        public void onAnimationEnd(Animation paramAnimation)
        {
          ...
          {
            paramAnimation = SwitchCompat.this;
          ...
          while (true)
          {
            paramAnimation.setThumbPosition(f);
  ...
  private Layout makeLayout(CharSequence paramCharSequence)
  {
    ...
    label62: for (int i = (int)Math.ceil(Layout.getDesiredWidth(paramCharSequence, this.mTextPaint)); ; i = 0)
    {
  ...
  private void stopDrag(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      bool1 = false;
      continue;
      label132: bool1 = getTargetCheckedState();
      continue;
      label141: bool1 = bool2;
    }
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (localObject3 != null)
    {
      ...
      label180: if (localObject1 != null)
      {
        localObject3 = getDrawableState();
        if (this.mTextColors != null)
          this.mTextPaint.setColor(this.mTextColors.getColorForState(localObject3, 0));
        this.mTextPaint.drawableState = ((I)localObject3);
        if (localObject2 == null)
          break label338;
        localObject2 = ((Drawable)localObject2).getBounds();
      }
    }
    label320: label329: label338: for (int i = ((Rect)localObject2).left + ((Rect)localObject2).right; ; i = getWidth())
    {
      i /= 2;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    else
    {
      ...
      label114: switch (getGravity() & 0x70)
      {
      default:
    ...
    while (true)
    {
      ...
      localRect1.setEmpty();
      break;
      label191: paramInt4 = getWidth() - getPaddingRight() - paramInt2;
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.mThumbDrawable != null)
    {
      ...
      label130: this.mThumbWidth = Math.max(k, j);
      if (this.mTrackDrawable == null)
        break label306;
      this.mTrackDrawable.getPadding(localRect);
    }
  ...
  public void setSwitchTextAppearance(Context paramContext, int paramInt)
  {
    ...
    label127: for (this.mSwitchTransformationMethod = new AllCapsTransformationMethod(getContext()); ; this.mSwitchTransformationMethod = null)
    {
  ...
  private class ThumbAnimation extends Animation
  {
    ...
    private ThumbAnimation(float paramFloat1, float arg3)
    {
      this.mStartPosition = paramFloat1;
      Object localObject;
      this.mEndPosition = localObject;
      this.mDiff = (localObject - paramFloat1);
    }
