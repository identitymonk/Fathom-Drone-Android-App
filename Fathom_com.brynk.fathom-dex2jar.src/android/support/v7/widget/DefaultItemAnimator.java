...
public class DefaultItemAnimator extends SimpleItemAnimator
{
  ...
  private void animateAddImpl(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    localViewPropertyAnimatorCompat.alpha(1.0F).setDuration(getAddDuration()).setListener(new VpaListenerAdapter(paramViewHolder, localViewPropertyAnimatorCompat)
    {
  ...
  private void animateChangeImpl(ChangeInfo paramChangeInfo)
  {
    ...
    label171: for (Object localObject2 = ((RecyclerView.ViewHolder)localObject2).itemView; ; localObject2 = null)
    {
      if (localObject1 != null)
      {
        ...
        ((ViewPropertyAnimatorCompat)localObject1).alpha(0.0F).setListener(new VpaListenerAdapter(paramChangeInfo, (ViewPropertyAnimatorCompat)localObject1)
        {
          public void onAnimationEnd(View paramView)
          {
      ...
      if (localObject2 != null)
      {
        ...
        ((ViewPropertyAnimatorCompat)localObject1).translationX(0.0F).translationY(0.0F).setDuration(getChangeDuration()).alpha(1.0F).setListener(new VpaListenerAdapter(paramChangeInfo, (ViewPropertyAnimatorCompat)localObject1, (View)localObject2)
        {
          public void onAnimationEnd(View paramView)
          {
  ...
  private void animateMoveImpl(RecyclerView.ViewHolder paramViewHolder, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    ((ViewPropertyAnimatorCompat)localObject).setDuration(getMoveDuration()).setListener(new VpaListenerAdapter(paramViewHolder, paramInt1, paramInt2, (ViewPropertyAnimatorCompat)localObject)
    {
      public void onAnimationCancel(View paramView)
      {
  ...
  private void animateRemoveImpl(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    localViewPropertyAnimatorCompat.setDuration(getRemoveDuration()).alpha(0.0F).setListener(new VpaListenerAdapter(paramViewHolder, localViewPropertyAnimatorCompat)
    {
      public void onAnimationEnd(View paramView)
      {
        this.val$animation.setListener(null);
