  ...
  implements ScrollingView, NestedScrollingChild
{
  ...
  public RecyclerView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    label467: for (boolean bool1 = true; ; bool1 = false)
    {
  ...
  private void dispatchLayoutStep1()
  {
    ...
    label194: RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo;
    while (true)
    {
      i += 1;
      break label137;
    ...
    label294: if (this.mState.mRunPredictiveAnimations)
    {
      saveOldPositions();
  ...
  private void processAdapterUpdatesAndSetAnimationFlags()
  {
    ...
    if (predictiveItemAnimationsEnabled())
    {
      ...
      if ((!this.mFirstLayoutComplete) || (this.mItemAnimator == null) || ((!this.mDataSetHasChangedAfterLayout) && (i == 0) && (!this.mLayout.mRequestedSimpleAnimations)) || ((this.mDataSetHasChangedAfterLayout) && (!this.mAdapter.hasStableIds())))
        break label184;
      bool1 = true;
      label118: State.access$2502(localState, bool1);
      localState = this.mState;
  ...
  void initAdapterManager()
  {
    this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback()
    {
      ...
      public void offsetPositionsForRemovingInvisible(int paramInt1, int paramInt2)
      {
        ...
        RecyclerView.this.mItemsAddedOrRemoved = true;
        RecyclerView.State.access$1712(RecyclerView.this.mState, paramInt2);
      }
  ...
  void offsetPositionRecordsForMove(int paramInt1, int paramInt2)
  {
    ...
    label131: this.mRecycler.offsetPositionRecordsForMove(paramInt1, paramInt2);
    requestLayout();
  }
      ...
      if (bool1)
      {
        ...
        if (Math.abs(m) > this.mTouchSlop)
        {
          ...
          if (m >= 0)
            break label531;
          i = -1;
          label456: this.mLastTouchX = (i * n + j);
          i = 1;
        }
      }
      j = i;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label342: for (this.mState.mItemCount = this.mAdapter.getItemCount(); ; this.mState.mItemCount = 0)
    {
      eatRequestLayout();
      this.mLayout.onMeasure(this.mRecycler, this.mState, paramInt1, paramInt2);
      resumeRequestLayout(false);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        i = i2;
        break;
        label800: k = j + this.mTouchSlop;
        break label639;
        label812: j = i + this.mTouchSlop;
        break label689;
        n = 0;
        break label761;
        label830: m = 0;
  ...
  public final class Recycler
  {
    ...
    RecyclerView.ViewHolder getScrapViewForPosition(int paramInt1, int paramInt2, boolean paramBoolean)
    {
      ...
      while (true)
      {
        ...
        label255: i += 1;
        continue;
        label264: RecyclerView.this.mChildHelper.detachViewFromParent(paramInt1);
      ...
      label366: return (RecyclerView.ViewHolder)null;
    }
    ...
    View getViewForPosition(int paramInt, boolean paramBoolean)
    {
        ...
        if (localObject2 == null)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!paramBoolean)
            {
              ...
              label187: recycleViewHolderInternal((RecyclerView.ViewHolder)localObject2);
            }
            localObject1 = null;
            i = j;
          }
      ...
      while (true)
      {
        ...
        j = 0;
        break;
        label310: if (!((RecyclerView.ViewHolder)localObject2).wasReturnedFromScrap())
          break label187;
      ...
      label335: int m = RecyclerView.this.mAdapter.getItemViewType(k);
      j = i;
      localObject2 = localObject1;
      if (RecyclerView.this.mAdapter.hasStableIds())
      {
      ...
      label597: if ((k != 0) && (!RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject2).hasAnyOfTheFlags(8192)))
      {
      ...
      if ((RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject2).isBound()))
      {
        ...
        label762: ((RecyclerView.LayoutParams)localObject1).mViewHolder = ((RecyclerView.ViewHolder)localObject2);
        if ((k == 0) || (i == 0))
          break label939;
      }
      label939: for (paramBoolean = true; ; paramBoolean = false)
      {
        ...
        i = j;
        break;
        label890: if (!RecyclerView.this.checkLayoutParams((ViewGroup.LayoutParams)localObject1))
        {
    ...
    public void run()
    {
      ...
      if (localScrollerCompat.computeScrollOffset())
      {
        ...
        if ((i1 != 0) || (i2 != 0))
        {
          ...
          label435: if (ViewCompat.getOverScrollMode(RecyclerView.this) != 2)
        ...
        if ((i5 == 0) || (!RecyclerView.this.mLayout.canScrollVertically()) || (i3 != i5))
          break label774;
        i = 1;
        label563: if ((i4 == 0) || (!RecyclerView.this.mLayout.canScrollHorizontally()) || (n != i4))
          break label779;
        j = 1;
        label590: if (((i4 != 0) || (i5 != 0)) && (j == 0) && (i == 0))
          break label784;
        i = 1;
        label610: if ((!localScrollerCompat.isFinished()) && (i != 0))
          break label789;
      ...
      while (true)
      {
        ...
        return;
        label667: if (localSmoothScroller.getTargetPosition() >= n)
        {
