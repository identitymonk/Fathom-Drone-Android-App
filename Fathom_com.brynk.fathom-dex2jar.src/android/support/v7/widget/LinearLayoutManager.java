  ...
  implements ItemTouchHelper.ViewDropHandler
{
  ...
  private void layoutForPredictiveAnimations(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2)
  {
    ...
    if (i < n)
    {
      ...
      while (true)
      {
        ...
        {
          i2 = 1;
          label115: if (i2 == this.mShouldReverseLayout)
            break label159;
        }
        ...
        label165: k += this.mOrientationHelper.getDecoratedMeasurement(localViewHolder.itemView);
      }
    }
  ...
  private boolean updateAnchorFromChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, AnchorInfo paramAnchorInfo)
  {
    ...
    label162: label164: label170: for (int i = this.mOrientationHelper.getEndAfterPadding(); ; i = this.mOrientationHelper.getStartAfterPadding())
    {
  ...
  int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      label111: paramLayoutState.mOffset += localLayoutChunkResult.mConsumed * paramLayoutState.mLayoutDirection;
      int j;
  ...
  View findOneVisibleChild(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label150: return (View)localObject1;
  }
  ...
  View findReferenceChild(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      i = -1;
      break;
      label131: if (this.mOrientationHelper.getDecoratedStart(localView) < k)
      {
        localObject1 = localView;
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    if (this.mLayoutState.mLastScrollDelta >= 0)
    {
      ...
      label257: if (!this.mAnchorInfo.mLayoutFromEnd)
        break label701;
      if (!this.mShouldReverseLayout)
        break label695;
      k = 1;
      label277: onAnchorReady(paramRecycler, paramState, this.mAnchorInfo, k);
    ...
    for (int k = i + k + j; ; k = i + n)
    {
      ...
      i = 0;
      break;
      label651: i = this.mOrientationHelper.getDecoratedStart((View)localObject);
      ...
      label695: k = -1;
      break label277;
      label701: if (this.mShouldReverseLayout);
      for (k = -1; ; k = 1)
        break;
      label720: updateLayoutStateToFillEnd(this.mAnchorInfo);
      this.mLayoutState.mExtra = i;
      fill(paramRecycler, this.mLayoutState, paramState, false);
      k = this.mLayoutState.mOffset;
      n = this.mLayoutState.mCurrentPosition;
      ...
      j = m;
      break label524;
      label919: k = fixLayoutStartGap(j, paramRecycler, paramState, true);
      i += k;
  ...
  public void smoothScrollToPosition(RecyclerView paramRecyclerView, RecyclerView.State paramState, int paramInt)
  {
    paramRecyclerView = new LinearSmoothScroller(paramRecyclerView.getContext())
    {
      public PointF computeScrollVectorForPosition(int paramInt)
      {
        return LinearLayoutManager.this.computeScrollVectorForPosition(paramInt);
      }
    };
