...
public class LinearLayoutCompat extends ViewGroup
{
  ...
  void drawDividersHorizontal(Canvas paramCanvas)
  {
    ...
    if (i < k)
    {
      ...
      label90: for (int j = localView.getRight() + localLayoutParams.rightMargin; ; j = localView.getLeft() - localLayoutParams.leftMargin - this.mDividerWidth)
      {
    ...
    while (true)
    {
      ...
      return;
      label151: i = getWidth() - getPaddingRight() - this.mDividerWidth;
      continue;
  ...
  void measureHorizontal(int paramInt1, int paramInt2)
  {
    ...
    label885: if ((this.mTotalLength > 0) && (hasDividerBeforeChildAt(i11)))
      this.mTotalLength += this.mDividerWidth;
    ...
    if ((i4 != 0) || ((i3 != 0) && (f1 > 0.0F)))
    {
      ...
      label1985: this.mTotalLength += getPaddingLeft() + getPaddingRight();
      if ((localObject[1] == -1) && (localObject[0] == -1) && (localObject[2] == -1))
      {
        i5 = j;
        i3 = n;
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    if ((i4 != 0) || ((i2 != 0) && (f1 > 0.0F)))
    {
      ...
      label1336: this.mTotalLength += getPaddingTop() + getPaddingBottom();
      i2 = k;
      i4 = j;
    }
    do
