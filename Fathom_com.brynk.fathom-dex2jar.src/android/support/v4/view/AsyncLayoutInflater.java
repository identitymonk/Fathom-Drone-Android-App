...
public final class AsyncLayoutInflater
{
  ...
  private Handler.Callback mHandlerCallback = new Handler.Callback()
  {
    public boolean handleMessage(Message paramMessage)
    {
      ...
      if (paramMessage.view == null)
        paramMessage.view = AsyncLayoutInflater.this.mInflater.inflate(paramMessage.resid, paramMessage.parent, false);
      paramMessage.callback.onInflateFinished(paramMessage.view, paramMessage.resid, paramMessage.parent);
      AsyncLayoutInflater.this.mInflateThread.releaseRequest(paramMessage);
      return true;
    }
  };
  ...
  private static class InflateThread extends Thread
  {
    ...
    public void enqueue(AsyncLayoutInflater.InflateRequest paramInflateRequest)
    {
      ...
      catch (java.lang.InterruptedException paramInflateRequest)
      {
      }
