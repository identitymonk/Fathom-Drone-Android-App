...
public class ViewPager extends ViewGroup
{
  ...
  void initViewPager()
  {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener()
    {
      ...
      public WindowInsetsCompat onApplyWindowInsets(View paramView, WindowInsetsCompat paramWindowInsetsCompat)
      {
        ...
        while (i < j)
        {
          WindowInsetsCompat localWindowInsetsCompat = ViewCompat.dispatchApplyWindowInsets(ViewPager.this.getChildAt(i), paramView);
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        if (f2 <= k + m)
          break;
        return;
        label271: float f4 = this.mAdapter.getPageWidth(i);
        f2 = (f1 + f4) * m;
        f1 += f4 + f3;
      }
      i += 1;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        break;
        label397: f1 = this.mInitialMotionX - this.mTouchSlop;
      }
      bool1 = bool2;
      if (!this.mIsBeingDragged)
        continue;
  ...
  void populate(int paramInt)
  {
    ...
    while (true)
    {
      ...
      if (n != this.mExpectedAdapterCount)
        ...
        catch (Resources.NotFoundException localObject1)
        {
          while (true)
      ...
      label672: label929: label1058: label1189: for (localObject1 = ((ItemInfo)localObject3).object; ; localObject1 = null)
      {
        ...
        label808: if ((localObject4 != null) && (k == ((ItemInfo)localObject4).position))
        {
        ...
        label1070: if ((localObject4 != null) && (i == ((ItemInfo)localObject4).position))
        {
          f1 = f3 + ((ItemInfo)localObject4).widthFactor;
          paramInt = k + 1;
          if (paramInt < this.mItems.size());
      ...
      label799: sortChildDrawingOrder();
      label923: if (!hasFocus())
        continue;
  ...
  void smoothScrollTo(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label113: i = this.mScroller.getStartX();
      break label54;
      label125: i = getScrollX();
    }
    label134: setScrollingCacheEnabled(true);
    setScrollState(2);
