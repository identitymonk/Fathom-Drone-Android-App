  ...
  implements Parcelable
{
  ...
  public static MediaDescriptionCompat fromMediaDescription(Object paramObject)
  {
    ...
    if (localBundle2 == null)
    {
      ...
      label119: localBuilder.setExtras(localBundle1);
      if (localObject == null)
        break label180;
    ...
    while (true)
    {
      ...
      break;
      label163: localBundle2.remove("android.support.v4.media.description.MEDIA_URI");
      localBundle2.remove("android.support.v4.media.description.NULL_BUNDLE_FLAG");
      localBundle1 = localBundle2;
      break label119;
      label180: if (Build.VERSION.SDK_INT < 23)
        continue;
