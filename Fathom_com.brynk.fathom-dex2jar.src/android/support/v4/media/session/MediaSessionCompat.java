    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
    ...
    private VolumeProviderCompat.Callback mVolumeCallback = new VolumeProviderCompat.Callback()
    {
      public void onVolumeChanged(VolumeProviderCompat paramVolumeProviderCompat)
      {
        if (MediaSessionCompat.MediaSessionImplBase.this.mVolumeProvider != paramVolumeProviderCompat)
          return;
        paramVolumeProviderCompat = new ParcelableVolumeInfo(MediaSessionCompat.MediaSessionImplBase.this.mVolumeType, MediaSessionCompat.MediaSessionImplBase.this.mLocalStream, paramVolumeProviderCompat.getVolumeControl(), paramVolumeProviderCompat.getMaxVolume(), paramVolumeProviderCompat.getCurrentVolume());
        MediaSessionCompat.MediaSessionImplBase.this.sendVolumeInfoChanged(paramVolumeProviderCompat);
      }
    };
    ...
    public MediaSessionImplBase(Context paramContext, String paramString, ComponentName paramComponentName, PendingIntent paramPendingIntent)
    {
      ...
      while (true)
      {
        ...
        label200: localObject = paramComponentName;
        if (localList.size() <= 1)
          continue;
    ...
    private MediaMetadataCompat cloneMetadataIfNeeded(MediaMetadataCompat paramMediaMetadataCompat)
    {
      ...
      return (MediaMetadataCompat)((MediaMetadataCompat.Builder)localObject).build();
    }
    ...
    private boolean update()
    {
      ...
      if (this.mIsActive)
      {
        ...
        label182: MediaSessionCompatApi14.setState(this.mRccObj, 0);
      ...
      while (true)
      {
        ...
        this.mIsRccRegistered = false;
        return false;
        label298: MediaSessionCompatApi8.unregisterMediaButtonEventReceiver(this.mContext, this.mMediaButtonReceiverComponentName);
      }
    }
    ...
    class MediaSessionStub extends IMediaSession.Stub
    {
      ...
      public void registerCallbackListener(IMediaControllerCallback paramIMediaControllerCallback)
      {
        ...
        catch (java.lang.Exception paramIMediaControllerCallback)
        {
        }
      }
