...
public final class MediaBrowserCompat
{
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
  {
    ...
    public void getItem(@NonNull String paramString, @NonNull MediaBrowserCompat.ItemCallback paramItemCallback)
    {
      ...
      {
        this.mHandler.post(new Runnable(paramItemCallback)
        {
          public void run()
          {
      ...
      public void onServiceConnected(ComponentName paramComponentName, IBinder paramIBinder)
      {
        postOrRun(new Runnable(paramComponentName, paramIBinder)
        {
          public void run()
          {
            ...
            {
              return;
              MediaBrowserCompat.MediaBrowserImplBase.access$1402(MediaBrowserCompat.MediaBrowserImplBase.this, new MediaBrowserCompat.ServiceBinderWrapper(this.val$binder, MediaBrowserCompat.MediaBrowserImplBase.this.mRootHints));
      ...
      implements MediaBrowserCompatApi21.SubscriptionCallback
    {
      ...
      public void onChildrenLoaded(@NonNull String paramString, List<Parcel> paramList)
      {
        ...
        while (true)
        {
          ...
          break label72;
          break;
          label117: MediaBrowserCompat.SubscriptionCallback.this.onChildrenLoaded(paramString, applyOptions(paramList, localBundle), localBundle);
        }
      }
