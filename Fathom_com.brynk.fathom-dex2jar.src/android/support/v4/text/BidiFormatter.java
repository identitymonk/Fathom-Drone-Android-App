...
public final class BidiFormatter
{
  ...
  public String unicodeWrap(String paramString, TextDirectionHeuristicCompat paramTextDirectionHeuristicCompat, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      if (!bool)
        break label142;
      int i = 8235;
      label80: localStringBuilder.append(i);
      localStringBuilder.append(paramString);
      localStringBuilder.append('‬');
      label104: if (paramBoolean)
        if (!bool)
          break label160;
    }
    label142: label150: label160: for (paramTextDirectionHeuristicCompat = TextDirectionHeuristicsCompat.RTL; ; paramTextDirectionHeuristicCompat = TextDirectionHeuristicsCompat.LTR)
    {
  ...
  private static class DirectionalityEstimator
  {
    ...
    byte dirTypeBackward()
    {
      ...
      {
        int k = Character.codePointBefore(this.text, this.charIndex);
        this.charIndex -= Character.charCount(k);
        i = Character.getDirectionality(k);
      }
      do
      {
        int j;
    ...
    byte dirTypeForward()
    {
      ...
      {
        int k = Character.codePointAt(this.text, this.charIndex);
        this.charIndex += Character.charCount(k);
        i = Character.getDirectionality(k);
      }
      do
