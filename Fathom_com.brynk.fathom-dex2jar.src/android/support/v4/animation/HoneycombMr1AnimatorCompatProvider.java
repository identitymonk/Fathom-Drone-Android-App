    ...
    implements ValueAnimatorCompat
  {
    ...
    public void addUpdateListener(AnimatorUpdateListenerCompat paramAnimatorUpdateListenerCompat)
    {
      if ((this.mWrapped instanceof ValueAnimator))
        ((ValueAnimator)this.mWrapped).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(paramAnimatorUpdateListenerCompat)
        {
          public void onAnimationUpdate(ValueAnimator paramValueAnimator)
          {
            this.val$animatorUpdateListener.onAnimationUpdate(HoneycombMr1AnimatorCompatProvider.HoneycombValueAnimatorCompat.this);
          }
        });
    }
