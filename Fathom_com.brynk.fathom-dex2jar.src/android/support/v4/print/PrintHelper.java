...
public final class PrintHelper
{
  ...
  private static final class PrintHelperApi20Impl extends PrintHelper.PrintHelperImpl<PrintHelperApi20>
  {
  ...
  private static final class PrintHelperApi23Impl extends PrintHelper.PrintHelperImpl<PrintHelperApi23>
  {
  ...
  private static final class PrintHelperApi24Impl extends PrintHelper.PrintHelperImpl<PrintHelperApi24>
  {
    ...
    implements PrintHelper.PrintHelperVersionImpl
  {
    ...
    public void printBitmap(String paramString, Bitmap paramBitmap, PrintHelper.OnPrintFinishCallback paramOnPrintFinishCallback)
    {
      ...
      if (paramOnPrintFinishCallback != null)
        local1 = new PrintHelperKitkat.OnPrintFinishCallback(paramOnPrintFinishCallback)
        {
      ...
      throws FileNotFoundException
    {
      2 local2 = null;
      if (paramOnPrintFinishCallback != null)
        local2 = new PrintHelperKitkat.OnPrintFinishCallback(paramOnPrintFinishCallback)
        {
          public void onFinish()
          {
            this.val$callback.onFinish();
  ...
  private static final class PrintHelperKitkatImpl extends PrintHelper.PrintHelperImpl<PrintHelperKitkat>
  {
