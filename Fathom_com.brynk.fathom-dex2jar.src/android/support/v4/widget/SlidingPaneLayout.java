...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      break;
      label148: paramInt1 = getPaddingLeft();
      break label35;
      label156: paramInt3 = getPaddingRight();
      break label46;
      label165: f = 0.0F;
    }
      ...
      if (j < i4)
      {
        ...
        while (true)
        {
          ...
          while (true)
          {
            ...
            paramInt1 = 0;
            break label750;
            label840: n = localView.getMeasuredWidth();
            break label757;
  ...
  static class SlidingPanelLayoutImplJB extends SlidingPaneLayout.SlidingPanelLayoutImplBase
  {
    ...
    SlidingPanelLayoutImplJB()
    {
      ...
      catch (NoSuchMethodException localNoSuchFieldException)
      {
        try
        {
          while (true)
