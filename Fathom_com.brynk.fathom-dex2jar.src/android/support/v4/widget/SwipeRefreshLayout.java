  ...
  implements NestedScrollingParent, NestedScrollingChild
{
  ...
  private final Animation mAnimateToCorrectPosition = new Animation()
  {
    public void applyTransformation(float paramFloat, Transformation paramTransformation)
    {
      ...
      for (int i = (int)(SwipeRefreshLayout.this.mSpinnerFinalOffset - Math.abs(SwipeRefreshLayout.this.mOriginalOffsetTop)); ; i = (int)SwipeRefreshLayout.this.mSpinnerFinalOffset)
      {
        ...
        i = (int)((i - SwipeRefreshLayout.this.mFrom) * paramFloat);
  ...
  private void moveSpinner(float paramFloat)
  {
    ...
    while (true)
    {
      ...
      break;
      label315: if ((this.mProgress.getAlpha() >= 255) || (isAnimationRunning(this.mAlphaMaxAnimation)))
        continue;
  ...
  private Animation startAlphaAnimation(int paramInt1, int paramInt2)
  {
    ...
    4 local4 = new Animation(paramInt1, paramInt2)
    {
      public void applyTransformation(float paramFloat, Transformation paramTransformation)
      {
        SwipeRefreshLayout.this.mProgress.setAlpha((int)(this.val$startingAlpha + (this.val$endingAlpha - this.val$startingAlpha) * paramFloat));
      }
    };
  ...
  public void onNestedPreScroll(View paramView, int paramInt1, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    while (true)
    {
      ...
      return;
      label139: this.mTotalUnconsumed -= paramInt2;
