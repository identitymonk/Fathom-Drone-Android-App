  ...
  implements NestedScrollingParent, NestedScrollingChild, ScrollingView
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.mEdgeGlowTop != null)
    {
      ...
      if (!this.mEdgeGlowTop.isFinished())
      {
        ...
        this.mEdgeGlowTop.setSize(k - m - i1, getHeight());
      ...
      if (!this.mEdgeGlowBottom.isFinished())
      {
        ...
        int n = getHeight();
        paramCanvas.translate(-k + getPaddingLeft(), Math.max(getScrollRange(), i) + n);
        paramCanvas.rotate(180.0F, k, 0.0F);
        this.mEdgeGlowBottom.setSize(k, n);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      label389: if (!this.mIsBeingDragged)
        continue;
      ...
      while (true)
      {
        ...
        endDrag();
        break;
        label782: if (!this.mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()))
          continue;
        ViewCompat.postInvalidateOnAnimation(this);
      }
  ...
  boolean overScrollByCompat(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      label209: j = 0;
      break label72;
      label215: paramInt1 = paramInt3;
      if (paramInt3 >= paramInt2)
        break label131;
      paramInt1 = paramInt2;
      paramBoolean = true;
      break label131;
      label230: paramInt2 = paramInt4;
