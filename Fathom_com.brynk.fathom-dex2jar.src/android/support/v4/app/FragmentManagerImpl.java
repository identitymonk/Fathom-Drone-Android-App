  ...
  implements LayoutInflaterFactory
{
  ...
  public void enqueueAction(Runnable paramRunnable, boolean paramBoolean)
  {
    ...
    //   1: ifne +7 -> 8
    //   4: aload_0
    //   5: invokespecial 626	android/support/v4/app/FragmentManagerImpl:checkStateLoss	()V
    //   8: aload_0
    //   9: monitorenter
    //   10: aload_0
    //   11: getfield 482	android/support/v4/app/FragmentManagerImpl:mDestroyed	Z
    //   14: ifne +10 -> 24
    //   17: aload_0
    //   18: getfield 317	android/support/v4/app/FragmentManagerImpl:mHost	Landroid/support/v4/app/FragmentHostCallback;
    //   21: ifnonnull +19 -> 40
    //   24: new 156	java/lang/IllegalStateException
    //   27: dup
    //   28: ldc_w 628
    //   31: invokespecial 161	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   34: athrow
    //   35: astore_1
    //   36: aload_0
    //   37: monitorexit
    ...
    //   44: ifnonnull +14 -> 58
    //   47: aload_0
    //   48: new 340	java/util/ArrayList
    //   51: dup
    //   52: invokespecial 341	java/util/ArrayList:<init>	()V
    ...
    //   62: aload_1
    //   63: invokevirtual 345	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   66: pop
    //   67: aload_0
    //   68: getfield 592	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   71: invokevirtual 399	java/util/ArrayList:size	()I
    //   74: iconst_1
    //   75: if_icmpne +32 -> 107
    //   78: aload_0
    //   79: getfield 317	android/support/v4/app/FragmentManagerImpl:mHost	Landroid/support/v4/app/FragmentHostCallback;
    //   82: invokevirtual 632	android/support/v4/app/FragmentHostCallback:getHandler	()Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 151	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   89: invokevirtual 638	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   92: aload_0
    //   93: getfield 317	android/support/v4/app/FragmentManagerImpl:mHost	Landroid/support/v4/app/FragmentHostCallback;
    //   96: invokevirtual 632	android/support/v4/app/FragmentHostCallback:getHandler	()Landroid/os/Handler;
    //   99: aload_0
    //   100: getfield 151	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   103: invokevirtual 642	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   106: pop
    //   107: aload_0
    //   108: monitorexit
    //   109: return
  ...
  void moveToState(Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    while (paramFragment.mState != i)
    {
      ...
      label532: label547: label615: Object localObject3;
      ...
      label1173: label1189: label1203: Object localObject2;
      try
      {
      ...
      catch (Resources.NotFoundException localObject2)
      {
        while (true)
        {
      ...
      case 2:
        while (true)
        {
          ...
          if ((paramFragment.mView != null) && (paramFragment.mContainer != null))
          {
            ...
            if (localObject2 != null)
            {
              ...
              paramFragment.mStateAfterAnimating = paramInt1;
              ((Animation)localObject2).setAnimationListener(new AnimateOnHWLayerIfNeededListener(paramFragment.mView, (Animation)localObject2, paramFragment)
              {
        ...
        label1759: paramFragment.mHost = null;
  ...
  public View onCreateView(View paramView, String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (k != -1)
    {
      ...
      if (k == 0)
        break label425;
      j = k;
      label295: paramView.mFragmentId = j;
      ...
      label354: if ((this.mCurState >= 1) || (!paramView.mFromLayout))
        break label561;
    ...
    while (true)
    {
      ...
      label425: j = i;
      break label295;
      label432: if (paramString.mInLayout)
      ...
      paramView = paramString;
      break label354;
      label561: moveToState(paramView);
    }
    label569: if (k != 0)
    ...
    while (true)
    {
      ...
      if (paramFragmentManagerNonConfig != null)
      {
        ...
        for (paramFragmentManagerNonConfig.mTarget = ((Fragment)this.mActive.get(paramFragmentManagerNonConfig.mTargetIndex)); ; paramFragmentManagerNonConfig.mTarget = null)
        {
          ...
          i = 0;
          break;
          label558: Log.w("FragmentManager", "Re-attaching retained fragment " + paramFragmentManagerNonConfig + " target no longer exists: " + paramFragmentManagerNonConfig.mTargetIndex);
        }
      }
      label605: if (localFragmentManagerState.mAdded != null)
      {
  ...
  FragmentManagerNonConfig retainNonConfig()
  {
    ...
    if ((localObject4 == null) && (localObject3 == null))
      return null;
    return (FragmentManagerNonConfig)(FragmentManagerNonConfig)new FragmentManagerNonConfig((List)localObject4, localObject3);
  }
  ...
  Parcelable saveAllState()
  {
    ...
    while (true)
    {
      ...
      if (i < m)
      {
        ...
        while (true)
        {
          ...
          i += 1;
          break;
          label361: ((FragmentState)localObject2).mSavedFragmentState = ((Fragment)localObject1).mSavedFragmentState;
        }
      }
      if (j != 0)
        break;
    ...
    ((FragmentManagerState)localObject3).mAdded = ((I)localObject1);
    ((FragmentManagerState)localObject3).mBackStack = ((BackStackState)localObject2);
    return (Parcelable)(Parcelable)(Parcelable)localObject3;
  }
  ...
  Bundle saveFragmentBasicState(Fragment paramFragment)
  {
    ...
    return (Bundle)(Bundle)localObject2;
  }
