  ...
  implements FragmentManager.BackStackEntry, Runnable
{
      ...
      if (this.mManager.mAdded != null)
      {
        ...
        if (i < this.mManager.mAdded.size())
        {
          ...
          while (true)
          {
            ...
            break;
            label197: setFirstOut(paramSparseArray1, paramSparseArray2, localFragment);
            localObject2 = localObject1;
          }
        }
      }
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    label220: localObject1 = new ArrayList();
    ...
    localObject5 = new FragmentTransitionCompat21.ViewRetriever((Fragment)localObject3)
    {
      public View getView()
      {
    ...
    if (localObject3 != null)
      if (!paramBoolean)
        break label478;
    label478: for (bool = ((Fragment)localObject3).getAllowReturnTransitionOverlap(); ; bool = ((Fragment)localObject3).getAllowEnterTransitionOverlap())
    {
  ...
  {
    paramView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener(paramView, paramTransitionState, paramInt, paramObject)
    {
  ...
  private void prepareSharedElementTransition(TransitionState paramTransitionState, View paramView, Object paramObject1, Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean, ArrayList<View> paramArrayList, Object paramObject2, Object paramObject3)
  {
    if (paramObject1 != null)
      paramView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener(paramView, paramObject1, paramArrayList, paramTransitionState, paramObject2, paramObject3, paramBoolean, paramFragment1, paramFragment2)
      {
        public boolean onPreDraw()
        {
          this.val$sceneRoot.getViewTreeObserver().removeOnPreDrawListener(this);
          ...
          ArrayMap localArrayMap = BackStackRecord.this.mapSharedElementsIn(this.val$state, this.val$isBack, this.val$inFragment);
          ...
          BackStackRecord.this.setEpicenterIn(localArrayMap, this.val$state);
          BackStackRecord.this.callSharedElementEnd(this.val$state, this.val$inFragment, this.val$outFragment, this.val$isBack, localArrayMap);
  ...
  public TransitionState popFromBackStack(boolean paramBoolean, TransitionState paramTransitionState, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    label112: bumpBackStackNesting(-1);
    int i;
    label125: int j;
    label133: int k;
    if (localTransitionState != null)
    {
      ...
      if (localTransitionState == null)
        break label278;
      k = 0;
      label150: if (localTransitionState == null)
        break label287;
    }
    label269: label278: label287: for (int m = 0; ; m = paramTransitionState.popExitAnim)
      switch (paramTransitionState.cmd)
      {
      default:
        throw new IllegalArgumentException("Unknown cmd: " + paramTransitionState.cmd);
        label235: localTransitionState = paramTransitionState;
        if (paramBoolean)
          break label112;
  ...
  public void run()
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (localObject2 == null)
        break label264;
      k = 0;
      label159: if (localObject2 == null)
        break label273;
    }
    label256: label264: label273: for (int m = 0; ; m = localOp.exitAnim)
      switch (localOp.cmd)
      {
      default:
      ...
      if (this.mManager.mAdded != null)
      {
        ...
        if (n >= 0)
        {
          ...
          while (true)
          {
            ...
            break;
            label471: if (localOp.removed == null)
    ...
    label755: this.mManager.moveToState(this.mManager.mCurState, j, i, true);
    if (this.mAddToBackStack)
