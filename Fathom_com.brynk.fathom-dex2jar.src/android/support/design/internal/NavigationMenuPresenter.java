  ...
  implements MenuPresenter
{
  ...
  private final View.OnClickListener mOnClickListener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      boolean bool = NavigationMenuPresenter.this.mMenu.performItemAction(paramView, NavigationMenuPresenter.this, 0);
      if ((paramView != null) && (paramView.isCheckable()) && (bool))
        NavigationMenuPresenter.this.mAdapter.setCheckedItem(paramView);
  ...
  private class NavigationMenuAdapter extends RecyclerView.Adapter<NavigationMenuPresenter.ViewHolder>
  {
    ...
    private void prepareMenuItems()
    {
      ...
      while (n < i4)
      {
        ...
        int i2 = localMenuItemImpl1.getGroupId();
        if (i2 != i1)
        {
          m = this.mItems.size();
