...
final class CollapsingTextHelper
{
  ...
  private void calculateBaseOffsets()
  {
    ...
    if (this.mTextToDraw != null)
    {
      ...
      if (!this.mIsRtl)
        break label387;
      i = 1;
      label61: i = GravityCompat.getAbsoluteGravity(k, i);
      switch (i & 0x70)
      {
      default:
        ...
        label144: switch (i & 0x800007)
        {
        default:
          this.mCollapsedDrawX = this.mCollapsedBounds.left;
          label188: calculateUsingTextSize(this.mExpandedTextSize);
          if (this.mTextToDraw != null)
          {
            f1 = this.mTextPaint.measureText(this.mTextToDraw, 0, this.mTextToDraw.length());
            label225: k = this.mExpandedTextGravity;
            if (!this.mIsRtl)
              break label472;
            i = j;
            label242: i = GravityCompat.getAbsoluteGravity(k, i);
            switch (i & 0x70)
            {
            default:
  ...
  private void calculateUsingTextSize(float paramFloat)
  {
    ...
    float f2;
    float f1;
    label80: label114: Object localObject;
    while (true)
    {
      return;
      j = 0;
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    while (true)
    {
      ...
      label138: i = 0;
      break;
      label144: f1 = this.mTextPaint.ascent() * this.mScale;
      this.mTextPaint.descent();
      f2 = this.mScale;
      break label74;
      label173: paramCanvas.drawText(this.mTextToDraw, 0, this.mTextToDraw.length(), f4, f2, this.mTextPaint);
    }
  }
