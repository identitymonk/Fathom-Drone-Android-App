  ...
  implements NestedScrollingParent
{
  ...
  final Comparator<View> mLayoutDependencyComparator = new Comparator()
  {
    public int compare(View paramView1, View paramView2)
    {
      if (paramView1 == paramView2)
        return 0;
      if (((CoordinatorLayout.LayoutParams)paramView1.getLayoutParams()).dependsOn(CoordinatorLayout.this, paramView1, paramView2))
        return 1;
      if (((CoordinatorLayout.LayoutParams)paramView2.getLayoutParams()).dependsOn(CoordinatorLayout.this, paramView2, paramView1))
        return -1;
      return 0;
    }
  };
  ...
  static
  {
    ...
    while (true)
    {
      ...
      localObject = null;
      break;
      label80: TOP_SORTED_CHILDREN_COMPARATOR = null;
      INSETS_HELPER = null;
    }
  }
  ...
  private WindowInsetsCompat setWindowInsets(WindowInsetsCompat paramWindowInsetsCompat)
  {
    ...
    label71: label76: for (boolean bool1 = bool2; ; bool1 = false)
    {
  ...
  public void onNestedPreScroll(View paramView, int paramInt1, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    if (k < i2)
    {
      ...
      label193: for (j = Math.max(j, this.mTempIntPair[1]); ; j = Math.min(j, this.mTempIntPair[1]))
      {
        m = 1;
        n = i;
        i1 = j;
