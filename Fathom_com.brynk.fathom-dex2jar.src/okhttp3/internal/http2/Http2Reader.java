  ...
  implements Closeable
{
    ...
    throws IOException
  {
    ...
    paramInt1 = lengthWithoutPadding(paramInt1, paramByte, i);
    ...
    throws IOException
  {
    ...
    if (paramInt2 < paramInt1)
    {
      ...
      while (i <= 16777215);
      label238: throw Http2.ioException("PROTOCOL_ERROR SETTINGS_MAX_FRAME_SIZE: %s", new Object[] { Integer.valueOf(i) });
    }
