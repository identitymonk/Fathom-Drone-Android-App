...
final class Relay
{
    ...
    implements Source
  {
      ...
      throws IOException
    {
      ...
      //   519: aconst_null
      //   520: putfield 85	okhttp3/internal/cache2/Relay:upstreamReader	Ljava/lang/Thread;
      //   523: aload_0
      //   524: getfield 21	okhttp3/internal/cache2/Relay$RelaySource:this$0	Lokhttp3/internal/cache2/Relay;
      //   527: invokevirtual 139	java/lang/Object:notifyAll	()V
      //   530: aload_1
      //   531: monitorexit
      //   532: aload 9
      //   534: athrow
